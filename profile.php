			...
			<div>
				...
				<table>
					...
					<tr>
						<td>Password:</td>
						<td>
							<input type="password" name="pw" value="<?=$user[2]?>" style="width: 300px" id=myPw>
						</td>
						<td><input type="checkbox" onclick="showpw()"> Show Password<td>
					</tr>
					<tr>
						<td>Nome:</td>
						<td>
							<input type="text" name="name" value="<?=$user[3]?>" style="width: 300px">
						</td>
					</tr>
					<tr>
						<td>Morada:</td>
					...
					<tr><td></td><td><button class="button">Save</button></td></tr>
